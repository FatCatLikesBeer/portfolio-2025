const projects: Project[] = [
  {
    id: "cryptor",
    name: "Cryptor",
    description: "Text File Encryption Utility",
    url: "https://github.com/FatCatLikesBeer/cryptor",
    github: "https://github.com/FatCatLikesBeer/cryptor",
    goals: "I had the need/desire to hide sensitive information that didn't need to be shared. I was also in the middle of learning C and ASCII and realized this was the perfect language for the goal. The encryption method is a salted Vigenère cypher.",
    tech: ["C"],
    numberOfAssets: 3,
    type: "project",
    imageFormat: "jpg",
  },
  {
    id: "project-flight",
    name: "Flight",
    description: "Self-destructing message service",
    url: "https://flight.billlaaayyy.dev",
    github: "https://github.com/FatCatLikesBeer/php-secret-service",
    goals: "I wanted to learn PHP, routing, PHP templating, and to excercise vanilla JavaScript (even though I really enjoy TypeScript). I picked a self-destructing/private messaging app as my project because it pushed me to learn security best practices in an environment known for it vulnerabilities.",
    tech: ["PHP", "PHPRouter", "No-build JavaScript", "SQLite", "Open Graph", "Twitter Cards"],
    numberOfAssets: 6,
    type: "project",
    imageFormat: "jpg",
  },
  ...
  },
  {
    ...
    github: "",
    goals: "Create a personal blog which explores pre-packaged backends. I chose to use PocketBase instead of Supabase because it's a smaller package and a cheaper options.",
  ...
  },
  {
    ...
    goals: "Explore the WebAudio API to prep for different project. During exploration, realized I could use device orientation as controls rather than graphical controls. ⚠️ CAUTION: LOUD!!!",
  ...
  },
  {
    ...
    goals: "First game leverging window, page, and click coordinates. First time using JS classes to encapsulate similar data types. Part of The Odin Project",
    tech: ["React", "MongoDB"],
    numberOfAssets: 3,
    type: "project",
    imageFormat: "jpg",
  ...
  },
  {
    ...
    github: "",
    goals: "This is my second programming course. I wanted to learn to build things using a popular framework. The previous Python course was focused on automation and scripting, but I really wanted to learn how to build user interfaces and interaction.",
  ...
  },
  {
    ...
    goals: "This was one of my first programming courses where I set out to learn new Python scripting techniques and re-hone my rusty programming skills.",
